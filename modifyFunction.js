...
function modifyFunction(sameFunc, multiplier) {
  return function(num) {
    const final = sameFunc(num);
...
// Arrow Method
const originalFunction2 = num => num**2;
const modifyFunction2 = (sameFunc, multiplier) => num => sameFunc(num) * multiplier;
const modifiedFunc2 = modifyFunction2(originalFunction2, 5);
console.log('Original function 2 output for 10:', originalFunction2(10));
console.log('Modified function 2 output for 10:', modifiedFunc2(10));
